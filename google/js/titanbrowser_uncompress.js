...
function gsr(q, t) {
        ...
        var customSearchControl = new google.search.CustomSearchControl( 'partner-pub-7090185500477706:3108617921');
        customSearchControl.enableAds("pub-7090185500477706");
...
function cl(){ $('#search-box').addClass('search-top-box').removeClass('search-middle-box'); $('#inpwrap').addClass('search-input-wrapper-top').removeClass('search-input-wrapper'); $('#logo-home').addClass('logo-top').removeClass('logo-home'); $('#powerlogo').hide(); $('#quickbar').remove(); $('#wrap-footer').remove(); $('#wrap-search-results').show(); $('#imglogo').width(120); m=1;$("#imglogo").wrap($('<a>',{href:'/'}));};
