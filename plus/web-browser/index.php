...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-42184865-1']);
      ...
      <div class="g-section g-tpl-160 g-split">
        ...
        <ul class="g-unit g-section g-tpl-nest" id="nav" role="menubar">
          <li class="g-unit current active">
            <a aria-haspopup="true" href="https://s3.amazonaws.com/titanbrowser/titan_browser_installer.exe" id="browser-menu" role="menuitem"><span data-g-event="nav-dropdown" data-g-label="browser-home">Product</span></a>
          ...
          <li class="g-unit">
            <a aria-haspopup="true" href="/plus/web-browser/support.php" id="device-menu" role="menuitem"><span data-g-event="nav-dropdown" data-g-label="devices-home">Support</span></a>
            <ul aria-labelledby="devices-menu" role="menu" style="display: block; left: 0px; top: -134px;">
            </ul>
          </li>
    ...
    <div class="browser-landing" id="main">
      <div class="compact marquee-stacked" id="marquee">
        <div class="marquee-copy">
          <h1><br>
            Get the new, fast & free web browser
          </h1>
          <p>
            A browser for your computer (Tablet and smartphone version comming soon)
          </p><a class="button eula-download-button" data-g-event="cta" data-g-label="download-chrome" href="https://s3.amazonaws.com/titanbrowser/titan_browser_installer.exe" onClick="_gaq.push(['_trackEvent', 'Download', 'clicked'])" >Download Titan Browser Plus</a>
          <p class="sub-button win">
            For Windows 8/7/Vista/XP
          </p>
          <p class="sub-button win8">
            For Windows 8/7/Vista/XP. Not available for Windows RT.
          </p>
          <p class="sub-button mac">
            For Mac OS X 10.6 or later
          </p>
          <p class="sub-button linux">
            For Linux (Debian/Ubuntu/Fedora/openSUSE)
          </p><span class="notice sub-button cros">Since you are on a Browserbook, you don't need to
          download Browser.<br>
          You will always have the most updated version automagically. Enjoy!</span>
        </div>
        <div class="marquee-image">
          <a class="eula-download-button" data-g-event="cta-img" data-g-label="download-chrome" href="javascript:void(0)"><img alt="" class="mac hi-dpi" src="./titan_files/download.png"> <img alt="" class="win hi-dpi" src="./titan_files/download.png">
          <img alt="" class="win8 hi-dpi" src="./titan_files/download.png"> <img alt="" class="linux hi-dpi" src="./titan_files/download.png">
          <img alt="" class="cros hi-dpi" src="./titan_files/download.png"></a>
        </div>
      </div>
      <div class="compact promos chrome-only">
        <div class="g-section g-tpl-nest g-col-4-4-4">
          <div class="g-unit g-first">
            <div class="g-content">
              ...
              <p>
                Personalize your Browsing experience installing Titan web browser.
              </p>
              <p class="more">
                <a data-g-event="promo-nav" data-g-label="browser-visit-webstore" href="#http://search.titanbrowser.com">
                Visit Browser Web Store</a>
              </p>
            </div>
          </div>
          <div class="g-unit">
            <div class="g-content">
              <h2>
                Get Browser for Mobile
              </h2>
              <p>
                Browse fast and sign in to take your web with you on your computer, phone and
                tablet.
              </p>
              <p class="more">
                <a data-g-event="promo-nav" data-g-label="browser-landing-mobile" href="/about" target="_blank">Learn more</a>
              </p>
            </div>
          </div>
          <div class="g-unit g-last">
            <div class="g-content">
              <h2>
                Block Spyware & Zero Malware
              </h2>
              <p>
                Titan web browser is one safe place for all your stuff. Download and Upload and access your files
                anywhere.
              </p>
              <p class="more">
                <a data-g-event="promo-nav" data-g-label="browser-drive-promo" href="/about">
                Learn more</a>
              </p>
            </div>
          </div>
...
<div id="social">
    ...
    <!-- twitter -->
    <div class="twitter">
    <a href="https://twitter.com/TitanBrowser" class="twitter-follow-button" data-show-count="false">Follow @TitanBrowser</a>
    <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>

    </div>
    <!-- end twitter -->
    <!-- like -->
    <div class="fb-like" data-send="false" data-layout="button_count" data-href="https://www.facebook.com/pages/Titan-Browser/162009204001277" data-width="90" data-show-faces="false"></div>
    <!-- end like -->
</div>
</div>
</div>
    ...
    <iframe frameborder="0" src="javascript:""" class="modal-dialog-bg" style="border: 0px; vertical-align: bottom; opacity: 0; width: 1899px; height: 1218px; display: none;"></iframe><div class="modal-dialog-bg" style="opacity: 0.5; width: 1899px; height: 1218px; display: none;"></div><div class="modal-dialog win" id="eula-dialog" aria-labelledby=":0" role="dialog" style="left: 568.5px; top: 115.73333333333333px; display: none;">
      <div class="modal-dialog-title modal-dialog-title-draggable" id=":0"><span class="modal-dialog-title-text"></span><span class="modal-dialog-title-close" style=""></span></div><div class="modal-dialog-content">
        <div class="g-section g-tpl-75-25 g-split">
          <h2>
            Get a Secure & fast, free web browser
