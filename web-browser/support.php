    ...
    <div class="compact" id="header">
      <div class="g-section g-tpl-160 g-split">
        <div class="g-unit g-first" id="header-logo">
          <a href="http://www.titanbrowser.com/web-browser/"><img alt="Browser" data-g-event="nav-logo" data-g-label="consumer-home" id="logo" width="90%" src="./titan_files/logo.png"></a>
        </div>
        <ul class="g-unit g-section g-tpl-nest" id="nav" role="menubar">
	  <li class="g-unit">
            <a aria-haspopup="true" href="/web-browser/" id="device-menu" role="menuitem"><span data-g-event="nav-dropdown" data-g-label="devices-home">Product</span></a>
          ...
          <li class="g-unit">
            <a aria-haspopup="true" href="/about" id="device-menu" role="menuitem"><span data-g-event="nav-dropdown" data-g-label="devices-home">About</span></a>
            <ul aria-labelledby="devices-menu" role="menu" style="display: block; left: 0px; top: -134px;">
            </ul>
          </li>
        </ul>
      ...
      <div class="g-section g-tpl-50-50 g-split" id="sub-footer">
        <div class="g-unit g-first">
          <ul id="chrome-footer-global">
            ...
            <li>
              <a data-g-event="nav-subfooter" data-g-label="about" href="http://www.titanbrowser.com/about">About Titan</a>
            </li>
            <li>
              <a data-g-event="nav-subfooter" data-g-label="privacy" href="http://www.titanbrowser.com/web-browser/privacy.html"> Privacy</a>
            </li>
          </ul>
        </div>
        <div class="g-unit">
